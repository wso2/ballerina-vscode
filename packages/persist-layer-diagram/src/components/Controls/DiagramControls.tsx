...
export function DiagramControls(props: ControlProps) {
    ...
    return (
        <ControlsStyles.Container>
            {hasDiagnostics && (
                <ControlsStyles.Button onClick={showProblemPanel} title='Diagnostics were detected'>
                    <Codicon name="warning" iconSx={{ fontSize: "16px", color: "var(--vscode-inputValidation-errorBorder)" }} />
