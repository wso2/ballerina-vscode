...
import { IDMFormProps, IDMFormField, IDMFormFieldValues, IntermediateClauseType, IntermediateClause, IntermediateClauseProps } from "@wso2/ballerina-core";
...
export function ClauseEditor(props: ClauseEditorProps) {
    ...
    const expressionField: IDMFormField = {
        key: "expression",
        label: "Expression",
        type: "EXPRESSION",
        optional: false,
    ...
    const handleSubmit = (data: IDMFormFieldValues) => {
        onSubmit({
