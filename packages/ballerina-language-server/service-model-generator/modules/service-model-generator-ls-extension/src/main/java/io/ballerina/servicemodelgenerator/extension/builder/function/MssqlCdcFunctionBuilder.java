...
import static io.ballerina.servicemodelgenerator.extension.builder.service.MssqlCdcServiceBuilder.BEFORE_ENTRY_FIELD;
...
/**
 * Represents the MSSQL CDC function builder of the service model generator. Handles special-case logic for onUpdate
