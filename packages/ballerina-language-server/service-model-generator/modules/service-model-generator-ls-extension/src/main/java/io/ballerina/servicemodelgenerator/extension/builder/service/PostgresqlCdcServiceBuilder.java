 ...
 * @since 1.5.0
 */
public final class PostgresqlCdcServiceBuilder extends AbstractServiceBuilder {
    ...
    public ServiceInitModel getServiceInitModel(GetServiceInitModelContext context) {
        InputStream resourceStream = PostgresqlCdcServiceBuilder.class.getClassLoader()
                .getResourceAsStream(CDC_POSTGRESQL_SERVICE_MODEL_LOCATION);
    ...
    public Map<String, List<TextEdit>> addServiceInitSource(AddServiceInitModelContext context)
        ...
        Import[] imports = new Import[]{
                ...
                new Import(BALLERINAX, POSTGRESQL_CDC_DRIVER_MODULE_NAME, true)
        };
    ...
    public Service getModelFromSource(ModelFromSourceContext context) {
        ...
        for (Function function : serviceModel.getFunctions()) {
            ...
            // Set module name on function codedata so router can correctly invoke PostgresqlCdcFunctionBuilder
     ...
     * invoke PostgresqlCdcFunctionBuilder.
     *
