...
public class ServiceModelGeneratorClientCapabilitySetter extends
        BallerinaClientCapabilitySetter<ServiceModelGeneratorClientCapabilities> {
    ...
    @Override
    public Class<ServiceModelGeneratorClientCapabilities> getCapability() {
        return ServiceModelGeneratorClientCapabilities.class;
    }
}
