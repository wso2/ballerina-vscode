 ...
 * @since 1.5.0
 */
public class UpdateListenerTest extends AbstractLSTest {
    ...
    public void test(Path config) throws IOException {
        ...
        ListenerModifierRequest request = new ListenerModifierRequest(
                sourceDir.resolve(testConfig.filePath()).toAbsolutePath().toString(), testConfig.listener());
        JsonObject jsonMap = getResponseAndCloseFile(request, testConfig.filePath())
        ...
        if (assertFailure) {
            TestConfig updatedConfig =
                    new TestConfig(testConfig.filePath(), testConfig.description(), testConfig.listener(), newMap);
//            updateConfig(configJsonPath, updatedConfig);
    ...
    protected Class<? extends AbstractLSTest> clazz() {
        return UpdateListenerTest.class;
    }
     ...
     */
    private record TestConfig(String filePath, String description, Listener listener,
