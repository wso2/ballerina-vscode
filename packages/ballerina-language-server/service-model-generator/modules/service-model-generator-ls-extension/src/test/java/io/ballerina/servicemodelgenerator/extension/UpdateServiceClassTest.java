...
public class UpdateServiceClassTest extends AbstractLSTest {
    ...
    public void test(Path config) throws IOException {
        ...
        ServiceClassSourceRequest request = new ServiceClassSourceRequest(
                sourceDir.resolve(testConfig.filePath()).toAbsolutePath().toString(), testConfig.serviceClass());
        ...
        if (assertFailure) {
            TestConfig updatedConfig =
                    new TestConfig(testConfig.filePath(), testConfig.description(), testConfig.serviceClass(), newMap);
//            updateConfig(configJsonPath, updatedConfig);
    ...
    protected String getResourceDir() {
        return "update_service_class";
    }

    @Override
    protected Class<? extends AbstractLSTest> clazz() {
        return UpdateServiceClassTest.class;
    }
     ...
     * @param serviceClass The service class to update.
     * @param output       The expected output.
     */
    private record TestConfig(String filePath, String description, ServiceClass serviceClass,
