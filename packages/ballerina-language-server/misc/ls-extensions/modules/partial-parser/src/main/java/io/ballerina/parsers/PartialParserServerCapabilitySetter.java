...
public class PartialParserServerCapabilitySetter extends
        BallerinaServerCapabilitySetter<PartialParserServerCapabilities> {

    @Override
    public Optional<PartialParserServerCapabilities> build() {
        PartialParserServerCapabilities capabilities = new PartialParserServerCapabilities();
    ...
    @Override
    public Class<PartialParserServerCapabilities> getCapability() {
        return PartialParserServerCapabilities.class;
    }
}
