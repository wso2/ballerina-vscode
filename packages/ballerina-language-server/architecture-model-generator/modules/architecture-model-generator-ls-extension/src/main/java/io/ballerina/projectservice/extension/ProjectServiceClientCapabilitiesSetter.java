...
public class ProjectServiceClientCapabilitiesSetter
        extends BallerinaClientCapabilitySetter<ProjectServiceClientCapabilities> {
    ...
    @Override
    public Class<ProjectServiceClientCapabilities> getCapability() {
        return ProjectServiceClientCapabilities.class;
    }
}
