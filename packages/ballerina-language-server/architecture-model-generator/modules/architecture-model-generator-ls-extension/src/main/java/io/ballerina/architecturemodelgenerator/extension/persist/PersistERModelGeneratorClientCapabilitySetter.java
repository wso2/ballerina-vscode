...
public class PersistERModelGeneratorClientCapabilitySetter extends
        BallerinaClientCapabilitySetter<PersistERModelGeneratorClientCapabilities> {
    ...
    @Override
    public Class<PersistERModelGeneratorClientCapabilities> getCapability() {
        return PersistERModelGeneratorClientCapabilities.class;
    }
}
