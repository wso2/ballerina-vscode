...
public class ProjectServiceServerCapabilitiesSetter extends
        BallerinaServerCapabilitySetter<ProjectServiceServerCapabilities> {

    @Override
    public Optional<ProjectServiceServerCapabilities> build() {
        ProjectServiceServerCapabilities capabilities = new ProjectServiceServerCapabilities();
    ...
    @Override
    public Class<ProjectServiceServerCapabilities> getCapability() {
        return ProjectServiceServerCapabilities.class;
    }
