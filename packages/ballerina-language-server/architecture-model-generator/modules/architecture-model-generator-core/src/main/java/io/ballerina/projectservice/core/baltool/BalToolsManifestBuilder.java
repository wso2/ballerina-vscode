...
public class BalToolsManifestBuilder {
    ...
    private final Map<String, BalToolsManifestBuilder.OldTool> oldTools;
    ...
    public Map<String, BalToolsManifestBuilder.OldTool> getOldTools() {
        return oldTools;
    }
        ...
        if (toolEntries.kind() == TomlType.TABLE_ARRAY) {
            ...
            for (TomlTableNode toolNode : toolTableArray.children()) {
                ...
                if (version == null || active.isEmpty()) {
                    oldTools.put(id, new BalToolsManifestBuilder.OldTool(id, org, name));
                    continue;
                }
