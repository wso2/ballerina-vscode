...
public class TestManagerServiceClientCapabilitySetter extends
        BallerinaClientCapabilitySetter<TestManagerServiceClientCapabilities> {
    ...
    @Override
    public Class<TestManagerServiceClientCapabilities> getCapability() {
        return TestManagerServiceClientCapabilities.class;
    }
}
