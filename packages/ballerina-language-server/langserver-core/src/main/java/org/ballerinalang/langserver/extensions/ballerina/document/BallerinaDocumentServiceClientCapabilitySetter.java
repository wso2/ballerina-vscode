...
/**
 * Client Capability setter for the {@link BallerinaDocumentService}.
 * 
 * @since 1.0.0
 */
...
public class BallerinaDocumentServiceClientCapabilitySetter
    ...
    @Override
    public Class<BallerinaDocumentClientCapabilities> getCapability() {
        return BallerinaDocumentClientCapabilities.class;
    }
}
