...
/**
 * Server capabilities for the ballerinaConnector service.
 *
 * @since 1.0.0
 */
public class BallerinaConnectorServerCapabilities extends BallerinaServerCapability {
    ...
    public BallerinaConnectorServerCapabilities() {
