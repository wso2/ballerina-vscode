...
/**
 * Client capability setter for the {@link BallerinaRunnerService}.
 *
 * @since 1.0.0
 */
...
public class BallerinaRunnerServiceClientCapabilitySetter extends
    ...
    @Override
    public Class<BallerinaRunnerServiceClientCapabilities> getCapability() {
        return BallerinaRunnerServiceClientCapabilities.class;
    }
}
