...
public class BallerinaSymbolServiceClientCapabilitySetter extends
        BallerinaClientCapabilitySetter<BallerinaSymbolClientCapabilities> {
    ...
    @Override
    public Class<BallerinaSymbolClientCapabilities> getCapability() {
        return BallerinaSymbolClientCapabilities.class;
    }
}
