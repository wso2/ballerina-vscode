...
/**
 * Client capabilities for the ballerinaConnector service.
 *
 * @since 1.0.0
 */
public class BallerinaConnectorClientCapabilities extends BallerinaClientCapability {
    ...
    public BallerinaConnectorClientCapabilities() {
