...
public class XMLSimpleNameNodeContext extends AbstractCompletionProvider<XMLSimpleNameNode> {

    public XMLSimpleNameNodeContext() {
        super(XMLSimpleNameNode.class);
    }

    @Override
    public List<LSCompletionItem> getCompletions(BallerinaCompletionContext context, XMLSimpleNameNode node) {
