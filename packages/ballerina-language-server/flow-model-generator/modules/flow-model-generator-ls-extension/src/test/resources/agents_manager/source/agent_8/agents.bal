...
final ai:Agent agent = check new (model = myModel,
    ...
    tools = [check new ai:McpToolKit("http://localhost:8000", permittedTools = (), info = {name: "MCP Server", version: ""})], agentType = ai:REACT_AGENT, memory = new ai:MessageWindowChatMemory(20));
