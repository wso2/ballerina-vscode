...
/**
 * Tests for the generation of data mapper transformation function.
 *
 * @since 1.2.0
 */
public class DataMappingTransformationFunctionTest extends AbstractLSTest {
    ...
    public void test(Path config) throws IOException {
        ...
        DataMapperTransformFunctionRequest request =
                new DataMapperTransformFunctionRequest(
...
//            updateConfig(configJsonPath, updatedConfig);
    ...
    protected String getResourceDir() {
        return "data_mapper_transformation_function";
    }

    @Override
    protected Class<? extends AbstractLSTest> clazz() {
        return DataMappingTransformationFunctionTest.class;
    }
    ...
    /**
     * Represents the test configuration for data mapper transformation function.
     *
