...
/**
 * Test for obtaining knowledge base node templates.
 *
 * @since 1.1.0
 */
public class GetNodeTemplateTest extends AbstractLSTest {
    ...
    protected Object[] getConfigsList() {
        return new Object[][]{
                {Path.of("get_vector_knowledge_base_node_template.json")}
        };
    }
     ...
     * @param codedata         The code data of the knowledge base
     * @param expectedTemplate The expected template of the knowledge base
     */
