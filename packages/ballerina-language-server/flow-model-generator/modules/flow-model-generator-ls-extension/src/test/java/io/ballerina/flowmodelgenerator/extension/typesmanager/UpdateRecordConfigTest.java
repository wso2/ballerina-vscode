...
public class UpdateRecordConfigTest extends AbstractLSTest {
    ...
    public void test(Path config) throws IOException {
        ...
        UpdatedRecordConfigRequest request = new UpdatedRecordConfigRequest(
                getSourcePath(testConfig.filePath()),
                testConfig.codedata(),
                testConfig.typeConstraint(), testConfig.expr());
...
//             updateConfig(configJsonPath, updateConfig);
    ...
    protected String getResourceDir() {
        return "update_record_config";
    }

    @Override
    protected Class<? extends AbstractLSTest> clazz() {
        return UpdateRecordConfigTest.class;
    }
    ...
    private record TestConfig(String filePath, String description, Codedata codedata,
                              String typeConstraint, String expr, JsonElement output) {
    }
}
