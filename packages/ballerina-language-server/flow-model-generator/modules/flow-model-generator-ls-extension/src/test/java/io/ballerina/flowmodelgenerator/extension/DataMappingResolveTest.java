...
/**
 * Tests for deleting invalid fields.
 *
 * @since 2.0.0
 */
public class DataMappingResolveTest extends AbstractLSTest {
    ...
    protected String getResourceDir() {
        return "data_mapper_resolve";
    }

    @Override
    protected Class<? extends AbstractLSTest> clazz() {
        return DataMappingResolveTest.class;
    }
