...
/**
 * Tests for the `addWorkflowManagement` service.
 *
 * @since 1.0.0
 */
public class AddWorkflowManagementTest extends AbstractLSTest {
...
//            updateConfig(configJsonPath, updatedConfig);
    ...
    protected String getResourceDir() {
        return "add_workflow_management";
    }

    @Override
    protected Class<? extends AbstractLSTest> clazz() {
        return AddWorkflowManagementTest.class;
    }
