 ...
 * @since 2.0.0
 */
public class DataMappingSourceV2Test extends AbstractLSTest {
    ...
    public void test(Path config) throws IOException {
        ...
        DataMapperSourceRequestV2 request =
                new DataMapperSourceRequestV2(sourceDir.resolve(testConfig.source()).toAbsolutePath().toString(),
