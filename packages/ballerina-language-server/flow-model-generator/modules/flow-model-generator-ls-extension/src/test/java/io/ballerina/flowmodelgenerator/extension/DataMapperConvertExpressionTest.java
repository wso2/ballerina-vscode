...
public class DataMapperConvertExpressionTest extends AbstractLSTest {
    ...
    protected Object[] getConfigsList() {
        return new Object[][]{
                {Path.of("boolean_to_byte.json")},
                {Path.of("boolean_to_decimal.json")},
                {Path.of("boolean_to_float.json")},
                {Path.of("boolean_to_int.json")},
                {Path.of("boolean_to_string.json")},
                {Path.of("byte_to_boolean.json")},
