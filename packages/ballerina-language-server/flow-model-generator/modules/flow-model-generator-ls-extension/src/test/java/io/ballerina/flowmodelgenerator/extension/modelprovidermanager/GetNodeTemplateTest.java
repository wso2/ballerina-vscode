...
/**
 * Test for obtaining model provider node templates.
 *
 * @since 1.1.0
 */
public class GetNodeTemplateTest extends AbstractLSTest {
    ...
    protected Object[] getConfigsList() {
        return new Object[][]{
                {Path.of("get_default_model_provider_template.json")},
     ...
     * @param codedata         The code data of the model provider
     * @param expectedTemplate The expected template of the model provider
     */
