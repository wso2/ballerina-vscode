...
/**
 * Test for obtaining data loader node templates.
 *
 * @since 1.1.1
 */
public class GetNodeTemplateTest extends AbstractLSTest {
     ...
     * @param codedata         The code data of the data loader
     * @param expectedTemplate The expected template of the data loader
     */
