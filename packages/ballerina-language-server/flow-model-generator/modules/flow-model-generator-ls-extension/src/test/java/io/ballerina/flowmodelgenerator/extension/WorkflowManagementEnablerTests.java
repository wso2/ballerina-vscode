...
/**
 * Tests for the `isWorkflowManagementEnabled` service.
 *
 * @since 1.0.0
 */
public class WorkflowManagementEnablerTests extends AbstractLSTest {
...
//            updateConfig(configJsonPath, updatedConfig);
    ...
    protected Class<? extends AbstractLSTest> clazz() {
        return WorkflowManagementEnablerTests.class;
    }

    @Override
    protected String getApiName() {
        return "isWorkflowManagementEnabled";
    }
    ...
    /**
     * Represents the test configuration for the workflow management enabler test.
     *
