 ...
 * @since 2.0.0
 */
public class DataMappingCompletionTest extends AbstractLSTest {
...
//            updateConfig(configJsonPath, updatedConfig);
    ...
    protected String getResourceDir() {
        return "data_mapper_completions";
    }

    @Override
    protected Class<? extends AbstractLSTest> clazz() {
        return DataMappingCompletionTest.class;
    }

    @Override
    protected String getApiName() {
        return "dataMapperCompletion";
    }
