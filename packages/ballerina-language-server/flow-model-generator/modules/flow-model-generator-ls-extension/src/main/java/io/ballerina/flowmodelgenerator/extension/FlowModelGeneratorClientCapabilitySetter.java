...
public class FlowModelGeneratorClientCapabilitySetter extends
        BallerinaClientCapabilitySetter<FlowModelGeneratorClientCapabilities> {
    ...
    @Override
    public Class<FlowModelGeneratorClientCapabilities> getCapability() {
        return FlowModelGeneratorClientCapabilities.class;
    }
}
