...
/**
 * Represents server capability setter for the flow model generator service.
 *
 * @since 1.0.0
 */
@JavaSPIService("org.ballerinalang.langserver.commons.registration.BallerinaServerCapabilitySetter")
public class FlowModelGeneratorServerCapabilitySetter extends
        BallerinaServerCapabilitySetter<FlowModelGeneratorServerCapabilities> {
    ...
    public String getCapabilityName() {
        return FlowModelGeneratorConstants.CAPABILITY_NAME;
    }

    @Override
    public Class<FlowModelGeneratorServerCapabilities> getCapability() {
        return FlowModelGeneratorServerCapabilities.class;
    }
}
