...
/**
 * Handles diagnostic requests for expression validation in clause.
 *
 * @see DiagnosticsRequest
 * @since 2.0.0
 */
public class DataMapperClauseDiagnosticsRequest extends DiagnosticsRequest {

    public DataMapperClauseDiagnosticsRequest(ExpressionEditorContext context) {
        super(context);
    }
