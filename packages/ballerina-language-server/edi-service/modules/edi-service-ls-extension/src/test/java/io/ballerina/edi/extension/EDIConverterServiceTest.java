...
/**
 * Test cases for EDI converter service.
 *
 * @since 1.4.0
 */
public class EDIConverterServiceTest extends AbstractLSTest {
    ...
    public void test(Path config) throws IOException {
        ...
        EDIConverterRequest request = new EDIConverterRequest(
                testConfig.schemaContent(),
        ...
        if (jsonMap == null) {
            ...
            Assert.fail("EDI conversion failed: " + error);
        }
...
//          updateConfig(configJsonPath, updatedConfig);
    ...
    protected Class<? extends AbstractLSTest> clazz() {
        return EDIConverterServiceTest.class;
    }
    ...
    protected String getApiName() {
        return "generateTypesFromEDI";
    }

    @Override
    protected String[] skipList() {
        // Skip all tests by default since they require Ballerina runtime (bal command)
        // To run these tests, ensure:
        // 1. Ballerina runtime is installed and 'bal' command is available
        // 2. Remove the test file name from this skip list
        // 3. Run: ./gradlew :edi-service:edi-service-ls-extension:test
        return new String[]{
            // "x12_210_sample.json"  // Test enabled - Ballerina runtime is available
        };
    }

    /**
     * Represents the test configuration for the EDI converter test.
     *
     * @param schemaContent  The EDI schema content (X12 XSD).
     * @param description The description of the test.
     * @param testProjectFolder The test project folder path.
     * @param output      The expected text edits output.
     */
    private record TestConfig(String schemaContent, String description, String testProjectFolder,
