...
const ExecutionStepsList: React.FC<ExecutionStepsListProps> = ({ toolCalls, traceId, onViewInTrace }) => {
    ...
    return (
        <StepsContent>
            {toolCalls.map((tool, idx) => (
                <ToolStep key={tool.spanId} onClick={() => onViewInTrace(traceId, tool.spanId)}>
