...
const Badge = styled.span<{ size: ExperimentalTagSize }>`
    ...
    height: ${(p: { size: ExperimentalTagSize }) => (p.size === "md" ? "15px" : "13px")};
    padding: 0 ${(p: { size: ExperimentalTagSize }) => (p.size === "md" ? "5px" : "4px")};
    font-family: var(--vscode-font-family);
    font-weight: 600;
    text-transform: uppercase;
    letter-spacing: 0.3px;
    font-size: ${(p: { size: ExperimentalTagSize }) => (p.size === "md" ? "9px" : "8px")};
    line-height: 1;
    border-radius: 3px;
