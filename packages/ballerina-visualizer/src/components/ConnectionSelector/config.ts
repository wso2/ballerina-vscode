...
export const CONNECTION_TYPE_CONFIGS: Record<ConnectionKind, ConnectionKindConfig> = {
    MODEL_PROVIDER: {
        ...
        inputTypes: [{ fieldType: "TEXT", ballerinaType: "ai:ModelProvider" }],
    ...
    VECTOR_STORE: {
        ...
        inputTypes: [{ fieldType: "TEXT", ballerinaType: "ai:VectorStore" }],
