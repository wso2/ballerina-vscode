...
const NODE_ICONS: Record<NodeKind, React.FC<{ size: number; color: string }>> = {
    ...
    WORKFLOW_START: ({ size, color }) => <Icon name="bi-workflow" sx={{ fontSize: size, width: size, height: size, color }} />,
    ACTIVITY_CALL: ({ size, color }) => <Icon name="bi-workflow" sx={{ fontSize: size, width: size, height: size, color }} />,
    SEND_EVENT: ({ size, color }) => <Icon name="bi-workflow" sx={{ fontSize: size, width: size, height: size, color }} />,
    WAIT_EVENT: ({ size, color }) => <Icon name="bi-wait" sx={{ fontSize: size, width: size, height: size, color }} />,
