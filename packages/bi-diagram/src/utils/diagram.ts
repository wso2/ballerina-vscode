...
import { SendEventNodeFactory } from "../components/nodes/SendEventNode";
import { WaitEventNodeFactory } from "../components/nodes/WaitEventNode";
import { WorkflowStartNodeFactory } from "../components/nodes/WorkflowStartNode";
...
export function generateEngine(): DiagramEngine {
    ...
    engine.getNodeFactories().registerFactory(new WorkflowStartNodeFactory());
    engine.getNodeFactories().registerFactory(new CallActivityNodeFactory());
    engine.getNodeFactories().registerFactory(new SendEventNodeFactory());
    engine.getNodeFactories().registerFactory(new WaitEventNodeFactory());
