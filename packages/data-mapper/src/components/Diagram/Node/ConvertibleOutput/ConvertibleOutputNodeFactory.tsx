...
import { ConvertibleOutputWidget } from "./ConvertibleOutputWidget";
import { OutputSearchNoResultFound, SearchNoResultFoundKind } from "../commons/Search";

import { ConvertibleOutputNode, CONVERTIBLE_OUTPUT_NODE_TYPE } from './ConvertibleOutputNode';

export class ConvertibleOutputNodeFactory extends AbstractReactFactory<ConvertibleOutputNode, DiagramEngine> {
    constructor() {
        super(CONVERTIBLE_OUTPUT_NODE_TYPE);
    }
    ...
    generateModel(): ConvertibleOutputNode {
        return undefined;
    }
}
