...
export interface IDataMapperContext {
    ...
    createConvertedVariable: (variableName: string, isInput: boolean, typeName?: string) => Promise<void>;
}
...
export class DataMapperContext implements IDataMapperContext {
    ...
    constructor(
        ...
        public createConvertedVariable: (variableName: string, isInput: boolean, typeName?: string) => Promise<void>
    ){}
}
